...
class ShapeNavigator extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path1.lineTo(size.width * .69, 0);
    path1.quadraticBezierTo(
        size.width * .77, 0, size.width * .77, size.height * .28);

    path1.lineTo(size.width * .77, size.height * .49);
    path1.quadraticBezierTo(size.width * .77, size.height * .76,
        size.width * .82, size.height * .75);
