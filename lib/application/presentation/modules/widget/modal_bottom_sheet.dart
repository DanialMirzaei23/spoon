...
void generateModalBottomSheet(BuildContext context,
    {required String title, required Widget child}) async {
  Widget toSpaceVertical({required BuildContext context, double size = .1}) =>
      SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              context: context, right: .04, left: .04, top: .02, bottom: .03),
        ),
      );
    },
  );
