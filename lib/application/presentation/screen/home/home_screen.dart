        ...
        child: Row(
          children: [
            Expanded(
              flex: 1,
              child:
                  SearchGenerate(titleField: context.toAppLocalization.search),
            ), // <------ No l10n file
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: SvgGenerated(
                  ...
                  router: GenerateDataImages.setting_group,
        ...
        child: Row(
          children: [
            Expanded(
                ...
                child: Row(
                  children: [
                    context.toAppLocalization.new_arrival.toText(
                        context: context,
                        fontSize: GenerateStyleFont.title2,
                        fontWeight: FontWeight.bold),
                    SvgGenerated(
                      generate: Generate.asset,
                      router: GenerateDataImages.fire_icon,
            ...
            Expanded(
              child: context.toAppLocalization.see_all.toText(
                  context: context,
